...
class ContactRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'tel1' => ['required', 'integer', 'digits_between:1,5'],
            'tel2' => ['required', 'integer', 'digits_between:1,5'],
            'tel3' => ['required', 'integer', 'digits_between:1,5'],
            'address' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'tel2.integer' => '電話番号は5桁までの数字で入力してください',
